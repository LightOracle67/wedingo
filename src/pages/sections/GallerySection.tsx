          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background: "color-mix(in srgb, var(--invite-shell-bg, rgba(255,255,255,0.45)) 90%, transparent)",
              }}
            >
            ...
            >
              <div className="gallery-main-image-wrap">
                ...
                {failedIds.has(currentImage?.id || "") && (
                  <p className="gallery-main-placeholder" aria-live="polite">
              ...
              return (
                ...
                >
                  ...
                  {failedIds.has(img.id) ? (
                    <span className="gallery-thumb__missing" aria-hidden="true">
                      •
                    </span>
                  ) : (
                    <img
