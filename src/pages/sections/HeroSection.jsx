...
const HeroSection = memo(function HeroSection({ style, className, firstName, secondName, inviteMessage, countdown }) {
  return (
    <section
      ...
      style={style}
    >
      <div className="invite-shell story-panel story-panel--hero relative z-10 mx-auto w-full max-w-[min(100%,38rem)] rounded-[2rem] bg-transparent text-center shadow-2xl" style={{ height: "80dvh", overflowY: "auto" }}>
