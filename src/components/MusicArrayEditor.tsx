...
const MusicArrayEditor = memo(function MusicArrayEditor({
  inviteToken,
  value,
  onChange,
}: {
      ...
      {hasMusic ? (
        ...
        >
          ...
          <label
            ...
            style={{ cursor: uploading ? "not-allowed" : "pointer", opacity: uploading ? 0.5 : 1, textAlign: "center" }}
          >
        ...
        >
          ...
          <span className="setup-upload__title">
            {uploading ? t("setup.musicUploading") : t("setup.musicUploadLabel")}
          </span>
