...
export const buildGoogleCalendarUrl = ({ title, description, place, startDate, endDate }: { title: string; description: string; place: string; startDate: Date; endDate: Date }) => {
