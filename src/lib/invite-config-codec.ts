const INVITE_KEY_MAP = {
  ...
  wp: "weddingPlace", su: "weddingSiteURL", mv: "weddingMapView", ms: "weddingMapStatic", dmm: "detailsMapMode", tmm: "transportMapMode", amm: "accommodationMapMode", te: "transportEnabled", td: "transportDepartures",
