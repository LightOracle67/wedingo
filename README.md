...
**Versión actual:** [v2.192.13](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2578 tests (vitest, 208 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.54% statements / 83.61% branches / 91.29% functions / 94.35% lines (gate 92/83/90/93.8) |
