...
**Versión actual:** [v2.192.15](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2582 tests (vitest, 209 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.58% statements / 83.70% branches / 91.41% functions / 94.40% lines (gate 92/83/90/93.8) |
