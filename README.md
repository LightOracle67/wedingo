...
**Versión actual:** [v2.124.3](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2255 tests (vitest) + suite Playwright e2e || Cobertura | 86.0% statements / 75.1% branches / 83.2% functions / 88.1% lines |
...
| Versión | Fecha | Hito |
| v2.124.3 | 2026-08-24 | Toggle «Vídeo de bienvenida» en Portada del setup: por fin es configurable desde la UI (URL + activación) con i18n completo y tests |
