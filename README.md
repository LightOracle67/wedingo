...
**Versión actual:** [v2.192.23](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2596 tests (vitest, 209 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.70% statements / 84.20% branches / 91.62% functions / 94.50% lines (gate 92/83/90/93.8) |
