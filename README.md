...
**Versión actual:** [v2.192.7](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2559 tests (vitest, 208 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.25% statements / 83.23% branches / 90.74% functions / 94.09% lines (gate 91.5/82.5/89.5/93.5) |
...
| v2.177.0 | 2026-08-29 | Modularización: la actualización de campos del RSVP (con límites de acompañantes y niños) y la asignación automática de invitados a mesas pasan a helpers puros con tests propios |
...
| v2.161.0 | 2026-08-27 | El menú del RSVP se muestra en un modal: los botones de carne, pescado y vegano abren los platos y quedan marcados al elegir (con distintivo Elegido); los menús fijos se abren con un botón de lupa |
| v2.160.0 | 2026-08-27 | Eliminado el código legacy restante: consentimiento parental (solo lectura de documentos antiguos) y los campos de teléfono/email del RSVP sin consumidores; la hoja global del Excel queda con 7 columnas y se verifica con scripts/check-fields-vs-rules.mjs que los campos escritos siguen permitidos por las reglas |
| v2.159.0 | 2026-08-27 | Los botones de asistencia del RSVP se muestran bajo el nombre del invitado; los toggles de menús y mapa estático usan el switch moderno; retirada la lista pública de confirmados y sus campos; verificación automática formulario→reglas; el panel del administrador se ajusta en pantallas pequeñas |
| v2.158.0 | 2026-08-27 | En móvil, el editor de platos de los menús del administrador apila cada campo a ancho completo en vez de anchos fijos que dejaban el texto estrecho |
| v2.157.0 | 2026-08-27 | El título «Menú» del RSVP se fija con estilo directo (1.05rem en negrita, verificado en producción) |
| v2.156.0 | 2026-08-27 | El título «Menú» del RSVP se muestra más grande y en negrita (la regla de etiquetas del setup lo mantenía pequeño) |
| v2.155.0 | 2026-08-27 | El menú del RSVP se muestra justo debajo del nombre y su título se amplía a «Elige tu menú» visible como cabecera de sección |
| v2.154.0 | 2026-08-27 | Recarga automática al detectar módulos obsoletos del service worker tras un despliegue (limpia SW y cachés, con tope de dos intentos) en vez de mostrar el error de carga |
| v2.153.0 | 2026-08-27 | El Excel de asistencias muestra datos legibles (transporte traducido con hora, niños como «Sí, N», menú predefinido como «Predefinido», columnas Intolerancias / Intolerancias (Niños)) y el menú elegido del RSVP se muestra en etiqueta separada |
...
| v2.132.0 | 2026-08-24 | Toggle «Vídeo de bienvenida» en Portada del setup: por fin es configurable desde la UI (URL + activación) con i18n completo y tests |
