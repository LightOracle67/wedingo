...
**Versión actual:** [v2.125.0](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2194 tests (vitest) + suite Playwright e2e || Cobertura | 86.0% statements / 75.1% branches / 83.2% functions / 88.1% lines |
...
| Versión | Fecha | Hito |
| v2.125.0 | 2026-08-24 | Toggle «Vídeo de bienvenida» en Portada del setup: por fin es configurable desde la UI (URL + activación) con i18n completo y tests |
