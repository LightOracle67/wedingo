...
**Versión actual:** [v2.51.0](https://github.com/LightOracle67/wedingo/releases/tag/v2.51.0)  
...
| Aspecto | Estado |
|---|---|
| Tests | 1801 tests, 143 test files |
| Cobertura | 94.7% statements / 92.2% branches / 94.1% functions / 96.2% lines |
