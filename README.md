...
**Versión actual:** [v2.192.14](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2580 tests (vitest, 208 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.55% statements / 83.62% branches / 91.33% functions / 94.37% lines (gate 92/83/90/93.8) |
