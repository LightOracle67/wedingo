...
**Versión actual:** [v2.128.0](https://github.com/LightOracle67/wedingo/releases)  
...
| Versión | Fecha | Hito |
| v2.128.0 | 2026-08-24 | Toggle «Vídeo de bienvenida» en Portada del setup: por fin es configurable desde la UI (URL + activación) con i18n completo y tests |
