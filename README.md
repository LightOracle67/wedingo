...
**Versión actual:** [v2.192.12](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2575 tests (vitest, 208 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.43% statements / 83.59% branches / 90.82% functions / 94.24% lines (gate 92/83/90/93.8) |
