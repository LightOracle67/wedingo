...
**Versión actual:** [v2.192.9](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2568 tests (vitest, 208 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.28% statements / 83.25% branches / 90.74% functions / 94.11% lines (gate 91.5/82.5/89.5/93.5) |
