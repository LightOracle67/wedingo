...
**Versión actual:** [v2.192.17](https://github.com/LightOracle67/wedingo/releases)  
...
| Aspecto | Estado |
|---|---|
| Tests | 2584 tests (vitest, 209 ficheros) + suite Playwright e2e live (18) || Cobertura | 92.62% statements / 83.74% branches / 91.50% functions / 94.42% lines (gate 92/83/90/93.8) |
